// Stripe Create Payment Intent - Dubai Account
import { serve } from 'https://deno.land/std@0.168.0/http/server.ts';
import { createClient } from 'https://esm.sh/@supabase/supabase-js@2';
import Stripe from 'https://esm.sh/stripe@14.11.0?target=deno';

const STRIPE_DUBAI_SECRET_KEY = 'sk_test_51SpUgAFuUBa8rcZHeoUyFxXOneDANww7M9XnEZo1pGqDCuI9Ag0GbdIFj0drPTEr5Xj0WMY04HjjZYA3ZTmvyAuR00Ya7Mx3YZ';
...
serve(async (req) => {
    ...
    try {
        ...
        // Initialize Stripe
        const stripe = new Stripe(STRIPE_DUBAI_SECRET_KEY!, {
